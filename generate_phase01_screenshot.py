...
# Capturing the Convolutional Neural Network (CNN) architecture built using Keras,
# which is perfect for Phase 01 Machine Learning documentation.
file_info = {"path": "train_light_model.py", "name": "9_Phase_01_CNN_Architecture.png", "lexer": "python", "lines": (85, 110)}
